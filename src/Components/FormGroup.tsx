...
const FormGroup: React.FC<formProps> = ({
    ...
    const dataDanger = [
        ...
        {label: 'Wilayah Kotor', value: 'Wilayah Kotor'},
        {label: 'Perang Warga', value: 'Perang Warga'},
        {label: 'Abu vulkanik', value: 'Abu vulkanik'},
        {label: 'Pengutan Liar', value: 'Pengutan Liar'},
        {label: 'Pembunuhan', value: 'Pembunuhan'},
        {label: 'Pedagang Liar', value: 'Pedagang Liar'},
        {label: 'Wilayah Terpencil', value: 'Wilayah Terpencil'},
        {label: 'Sepi Penduduk', value: 'Sepi Penduduk'},
        {label: 'Padat Penduduk', value: 'Padat Penduduk'},
        {label: 'Lumpur Hidup', value: 'Lumpur Hidup'},
        {label: 'Pandemi/Wabah', value: 'Pandemi/Wabah'},
        {label: 'Mabuk', value: 'Mabuk'},
        {label: 'Narkoba', value: 'Narkoba'},
        {label: 'Penipuan', value: 'Penipuan'},
        {label: 'Cuaca Ekstrim', value: 'Cuaca Ekstrim'},
        {label: 'Mayoritas Anak-anak', value: 'Mayoritas Anak-anak'},
        {label: 'Fanatisme (Agama)', value: 'Fanatisme (Agama)'},
        {label: 'Fanatisme (Olahraga)', value: 'Fanatisme (Olahraga)'},
        {label: 'Fanatisme (Organisasi)', value: 'Fanatisme (Organisasi)'},
        {label: 'Pengungsi Liar', value: 'Pengungsi Liar'},
        {label: 'Parkir Liar', value: 'Parkir Liar'},
        {label: 'Mayoritas Lansia', value: 'Mayoritas Lansia'},
